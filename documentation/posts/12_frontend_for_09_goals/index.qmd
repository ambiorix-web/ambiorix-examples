...
subtitle: "shiny meets ambiorix"
author: "Kennedy Mwavu"
date: "2024-07-26"
categories: [frontend_for_09_goals]
---

# Goals

This is a frontend for example [`09_goals`](../09_goals/index.qmd). Built using `{shiny}`.
...
1. First make sure that the backend is running. See how [here](../09_goals/index.qmd).
